# Backend Software Engineering Training Plan (TypeScript + NestJS)
...
#### Week 2: NestJS Framework Fundamentals
- **Priority**: HIGH
- **Daily**: 2-3 hours
- **Resources**:
...
#### Week 6: GraphQL API Development
